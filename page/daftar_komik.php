...
<div class="row">
    <div class="col-md-4 mb-5 text-center">
        <img class="img-komik" src="assets/img/<?= $gambar; ?>" alt="<?= $judul; ?>">
    </div>
    <div class="col-md-8 mb-5">
        ...
        <form action="modal/p_transaksi.php" method="post">
            <input type="hidden" name="id_komik" value="<?= $id_komik; ?>">
            <div class="row">
                <div class="col">
                    <input type="number" class="form-control" placeholder="Jumlah Sewa" name="jumlah_sewa" min="1" max="<?= $jumlah; ?>" required>
                </div>
                <div class="col">
                    <button type="submit" class="btn btn-success" name="btnaddcart" > 
